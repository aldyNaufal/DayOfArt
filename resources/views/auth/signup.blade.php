...
<div class="flex flex-col lg:flex-row w-full h-full">
    <div class="w-full h-full lg:w-1/2 lg:h-full relative">
        <img src="{{ asset('assets/images/signup.png') }}" alt="Signin Image" class="w-full h-screen object-cover">
    ...
    <div class="lg:w-1/2 flex items-center justify-center p-8 lg:mt-5">
        <div >
            ...
            <form action="{{ route('signup-post' )}}" method="POST">
                ...
                <div class="flex flex-col gap-2">
                    <input type="text" placeholder="Fulname" name="name" class="w-96 px-4 py-2 border rounded-md mb-4 shadow-md outline-none">
