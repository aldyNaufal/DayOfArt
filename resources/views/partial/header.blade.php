<div class="w-full bg-[#E145A6] 2xl:py-2 2xl:px-32 xl:px-18 xl:pr-10 lg:py-2 lg:px-12 md:py-2 md:px-10 sm:px-6 sm:py-2 flex flex-row justify-between items-center shadow-md">
    ...
    <img src="{{ asset('assets/icons/logo DoA transparent 2.png') }}" alt="Logo doa" class="sm:w-12 sm:ml-4 md:w-15 lg:w-18 xl:w-20 2xl:w-22"></img>
        ...
        <div class="relative group">
            <p class="hover:text-text-[#cb3e95] 2xl:text-xl sm:text-xs md:text-sm lg:text-md xl:text-lg">Activities</p>
        ...
        <a href="#" class="hover:text-text-[#cb3e95] 2xl:text-xl sm:text-xs md:text-sm lg:text-md xl:text-lg">Profile</a>
        ...
        <div class="flex flex-row justify-center items-center">
            ...
            <a href="{{ route('signin') }}" class="hover:text-text-[#cb3e95] 2xl:text-xl sm:text-xs md:text-sm lg:text-md xl:text-lg">Login</a>
         </div>
