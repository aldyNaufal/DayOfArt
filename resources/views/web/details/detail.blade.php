...
<div class="w-full ">
        ...
        <div class="absolute top-0 right-0 mt-4 mr-4 flex space-x-2 sm:mt-2 sm:mr-2 sm:space-x-1">
            <div class="bg-white p-2 rounded shadow-md cursor-pointer transform transition
            -transform duration-300 hover:scale-105 sm:p-1">
                <img src="{{ asset('assets/icons/bookmark.png') }}" alt="bookmark" class="md:w-4 sm:w-3"/>
            </div>
            <div class="bg-white p-2 rounded shadow-md cursor-pointer transform transition-transform duration-300 hover:scale-105 sm:p-1">
        ...
        <div class="w-4/5 mx-auto px-6 py-10 flex lg:flex-row gap-14 sm:flex-col">
            <div class="lg:w-2/3 bg-white shadow-md p-5 sm:w-full"> 
                <div class="mb-6">
                    ...
                    <p class="text-gray-700 mt-2 text-left w-full xl:leading-10 sm:leading-6 lg:leading-7 xl:text-md lg:text-base sm:text-xs">
